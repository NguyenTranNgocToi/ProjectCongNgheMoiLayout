        ...
        for(let i=0;i< list.length;i++){
            if(list[i].NgayHoc=="Thứ 2"){
                if(list[i].TietHoc=="01-03"){
                    thu2_13_gv =list[i].HoTen;
                    thu2_13_malop =list[i].MaLopHP;
                    thu2_13_nhom =list[i].Nhom;
                    thu2_13_phong =list[i].PhongHoc;
                    thu2_13_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="04-06"){
                    thu2_46_gv =list[i].HoTen;
                    thu2_46_malop =list[i].MaLopHP;
                    thu2_46_nhom =list[i].Nhom;
                    thu2_46_phong =list[i].PhongHoc;
                    thu2_46_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="07-09"){
                    thu2_79_gv =list[i].HoTen;
                    thu2_79_malop =list[i].MaLopHP;
                    thu2_79_nhom =list[i].Nhom;
                    thu2_79_phong =list[i].PhongHoc;
                    thu2_79_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="10-12"){
                    thu2_1012_gv =list[i].HoTen;
                    thu2_1012_malop =list[i].MaLopHP;
                    thu2_1012_nhom =list[i].Nhom;
                    thu2_1012_phong =list[i].PhongHoc;
                    thu2_1012_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="13-15"){
                    thu2_1315_gv =list[i].HoTen;
                    thu2_1315_malop =list[i].MaLopHP;
                    thu2_1315_nhom =list[i].Nhom;
                    thu2_1315_phong =list[i].PhongHoc;
                    thu2_1315_tenmon =list[i].TenMHHP;
                }         
            }
            if(list[i].NgayHoc=="Thứ 3"){
                if(list[i].TietHoc=="01-03"){
                    thu3_13_gv =list[i].HoTen;
                    thu3_13_malop =list[i].MaLopHP;
                    thu3_13_nhom =list[i].Nhom;
                    thu3_13_phong =list[i].PhongHoc;
                    thu3_13_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="04-06"){
                    thu3_46_gv =list[i].HoTen;
                    thu3_46_malop =list[i].MaLopHP;
                    thu3_46_nhom =list[i].Nhom;
                    thu3_46_phong =list[i].PhongHoc;
                    thu3_46_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="07-09"){
                    thu3_79_gv =list[i].HoTen;
                    thu3_79_malop =list[i].MaLopHP;
                    thu3_79_nhom =list[i].Nhom;
                    thu3_79_phong =list[i].PhongHoc;
                    thu3_79_tenmon =list[i].TenMHHP;
                }
                
                if(list[i].TietHoc=="10-12"){
                    thu3_1012_gv =list[i].HoTen;
                    thu3_1012_malop =list[i].MaLopHP;
                    thu3_1012_nhom =list[i].Nhom;
                    thu3_1012_phong =list[i].PhongHoc;
                    thu3_1012_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="13-15"){
                    thu3_1315_gv =list[i].HoTen;
                    thu3_1315_malop =list[i].MaLopHP;
                    thu3_1315_nhom =list[i].Nhom;
                    thu3_1315_phong =list[i].PhongHoc;
                    thu3_1315_tenmon =list[i].TenMHHP;
                }
            }
            if(list[i].NgayHoc=="Thứ 4"){
                if(list[i].TietHoc=="01-03"){
                    thu4_13_gv =list[i].HoTen;
                    thu4_13_malop =list[i].MaLopHP;
                    thu4_13_nhom =list[i].Nhom;
                    thu4_13_phong =list[i].PhongHoc;
                    thu4_13_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="04-06"){
                    thu4_46_gv =list[i].HoTen;
                    thu4_46_malop =list[i].MaLopHP;
                    thu4_46_nhom =list[i].Nhom;
                    thu4_46_phong =list[i].PhongHoc;
                    thu4_46_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="07-09"){
                    thu4_79_gv =list[i].HoTen;
                    thu4_79_malop =list[i].MaLopHP;
                    thu4_79_nhom =list[i].Nhom;
                    thu4_79_phong =list[i].PhongHoc;
                    thu4_79_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="10-12"){
                    thu4_1012_gv =list[i].HoTen;
                    thu4_1012_malop =list[i].MaLopHP;
                    thu4_1012_nhom =list[i].Nhom;
                    thu4_1012_phong =list[i].PhongHoc;
                    thu4_1012_tenmon =list[i].TenMHHP;
                }
                   
                if(list[i].TietHoc=="13-15"){
                    thu4_1315_gv =list[i].HoTen;
                    thu4_1315_malop =list[i].MaLopHP;
                    thu4_1315_nhom =list[i].Nhom;
                    thu4_1315_phong =list[i].PhongHoc;
                    thu4_1315_tenmon =list[i].TenMHHP;
                }
            }
            if(list[i].NgayHoc=="Thứ 5"){
                if(list[i].TietHoc=="01-03"){
                    thu5_13_gv =list[i].HoTen;
                    thu5_13_malop =list[i].MaLopHP;
                    thu5_13_nhom =list[i].Nhom;
                    thu5_13_phong =list[i].PhongHoc;
                    thu5_13_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="04-06"){
                    thu5_46_gv =list[i].HoTen;
                    thu5_46_malop =list[i].MaLopHP;
                    thu5_46_nhom =list[i].Nhom;
                    thu5_46_phong =list[i].PhongHoc;
                    thu5_46_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="07-09"){
                    thu5_79_gv =list[i].HoTen;
                    thu5_79_malop =list[i].MaLopHP;
                    thu5_79_nhom =list[i].Nhom;
                    thu5_79_phong =list[i].PhongHoc;
                    thu5_79_tenmon =list[i].TenMHHP;
                }
                    
                if(list[i].TietHoc=="10-12"){
                    thu5_1012_gv =list[i].HoTen;
                    thu5_1012_malop =list[i].MaLopHP;
                    thu5_1012_nhom =list[i].Nhom;
                    thu5_1012_phong =list[i].PhongHoc;
                    thu5_1012_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="13-15"){
                    thu5_1315_gv =list[i].HoTen;
                    thu5_1315_malop =list[i].MaLopHP;
                    thu5_1315_nhom =list[i].Nhom;
                    thu5_1315_phong =list[i].PhongHoc;
                    thu5_1315_tenmon =list[i].TenMHHP; 
                }
            }
            if(list[i].NgayHoc=="Thứ 6"){
                if(list[i].TietHoc=="01-03"){
                    thu6_13_gv =list[i].HoTen;
                    thu6_13_malop =list[i].MaLopHP;
                    thu6_13_nhom =list[i].Nhom;
                    thu6_13_phong =list[i].PhongHoc;
                    thu6_13_tenmon =list[i].TenMHHP;  
                }
                if(list[i].TietHoc=="04-06"){
                    thu6_46_gv =list[i].HoTen;
                    thu6_46_malop =list[i].MaLopHP;
                    thu6_46_nhom =list[i].Nhom;
                    thu6_46_phong =list[i].PhongHoc;
                    thu6_46_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="07-09"){
                    thu6_79_gv =list[i].HoTen;
                    thu6_79_malop =list[i].MaLopHP;
                    thu6_79_nhom =list[i].Nhom;
                    thu6_79_phong =list[i].PhongHoc;
                    thu6_79_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="10-12"){
                    thu6_1012_gv =list[i].HoTen;
                    thu6_1012_malop =list[i].MaLopHP;
                    thu6_1012_nhom =list[i].Nhom;
                    thu6_1012_phong =list[i].PhongHoc;
                    thu6_1012_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="13-15"){
                    thu6_1315_gv =list[i].HoTen;
                    thu6_1315_malop =list[i].MaLopHP;
                    thu6_1315_nhom =list[i].Nhom;
                    thu6_1315_phong =list[i].PhongHoc;
                    thu6_1315_tenmon =list[i].TenMHHP;
                }
            }
            if(list[i].NgayHoc=="Thứ 7"){
                if(list[i].TietHoc=="01-03"){
                    thu7_13_gv =list[i].HoTen;
                    thu7_13_malop =list[i].MaLopHP;
                    thu7_13_nhom =list[i].Nhom;
                    thu7_13_phong =list[i].PhongHoc;
                    thu7_13_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="04-06"){
                    thu7_46_gv =list[i].HoTen;
                    thu7_46_malop =list[i].MaLopHP;
                    thu7_46_nhom =list[i].Nhom;
                    thu7_46_phong =list[i].PhongHoc;
                    thu7_46_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="07-09"){
                    thu7_79_gv =list[i].HoTen;
                    thu7_79_malop =list[i].MaLopHP;
                    thu7_79_nhom =list[i].Nhom;
                    thu7_79_phong =list[i].PhongHoc;
                    thu7_79_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="10-12"){
                    thu7_1012_gv =list[i].HoTen;
                    thu7_1012_malop =list[i].MaLopHP;
                    thu7_1012_nhom =list[i].Nhom;
                    thu7_1012_phong =list[i].PhongHoc;
                    thu7_1012_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="13-15"){
                    thu7_1315_gv =list[i].HoTen;
                    thu7_1315_malop =list[i].MaLopHP;
                    thu7_1315_nhom =list[i].Nhom;
                    thu7_1315_phong =list[i].PhongHoc;
                    thu7_1315_tenmon =list[i].TenMHHP;
                }
            }
            if(list[i].NgayHoc=="Chủ nhật"){
                if(list[i].TietHoc=="01-03"){
                    chunhat_13_gv =list[i].HoTen;
                    chunhat_13_malop =list[i].MaLopHP;
                    chunhat_13_nhom =list[i].Nhom;
                    chunhat_13_phong =list[i].PhongHoc;
                    chunhat_13_tenmon =list[i].TenMHHP;
                }
                
                if(list[i].TietHoc=="04-06"){
                    chunhat_46_gv =list[i].HoTen;
                    chunhat_46_malop =list[i].MaLopHP;
                    chunhat_46_nhom =list[i].Nhom;
                    chunhat_46_phong =list[i].PhongHoc;
                    chunhat_46_tenmon =list[i].TenMHHP;
                }
                if(list[i].TietHoc=="07-09"){
                    chunhat_79_gv =list[i].HoTen;
                    chunhat_79_malop =list[i].MaLopHP;
                    chunhat_79_nhom =list[i].Nhom;
                    chunhat_79_phong =list[i].PhongHoc;
                    chunhat_79_tenmon =list[i].TenMHHP;
                }
                
                if(list[i].TietHoc=="10-12"){
                    chunhat_1012_gv =list[i].HoTen;
                    chunhat_1012_malop =list[i].MaLopHP;
                    chunhat_1012_nhom =list[i].Nhom;
                    chunhat_1012_phong =list[i].PhongHoc;
                    chunhat_1012_tenmon =list[i].TenMHHP;
                }
            
                if(list[i].TietHoc=="13-15"){
                    chunhat_1315_gv =list[i].HoTen;
                    chunhat_1315_malop =list[i].MaLopHP;
                    chunhat_1315_nhom =list[i].Nhom;
                    chunhat_1315_phong =list[i].PhongHoc;
                    chunhat_1315_tenmon =list[i].TenMHHP;
                }
            }
